#!/usr/bin/env python
""" 57. Create a Restore Function to correct the ARP tables in both the router and target so traffic can flow normally"""
...
try:
    ...
    restore("192.168.198.130", "192.168.198.2")
